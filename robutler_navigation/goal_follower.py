...
from rospy.duration import Duration # Handles time for ROS 2
import rospy # Python client library for ROS 2
...
def main():
  ...
  navigator = actionlib.SimpleActionClient('move_base',MoveBaseAction)
